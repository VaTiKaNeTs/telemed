...
/***********************************************************************************************/
// Функция, переводящая часы и минуты в минуты с начала дня
...
/***********************************************************************************************/
// Функция, возвращающая час (целая часть) из минут с начала дня
...
/***********************************************************************************************/
// Функция, возвращающая минуты (остаток от деления) из минут с начала дня
int minOfHour(int totalMinutes) 
{
    return totalMinutes % 60;
}